  ...
  !(function (e, t) {
    ...
    (T.extend({
      ...
      clone: function (e, t, n) {
        ...
        return (
          0 < (s = k(c, "script")).length && Se(s, !d && k(e, "script")),
          c
        );
      },
          ...
          v(t, [
            ...
            },
            {
              ...
              value: function () {
                var e = new I();
                return (
                  this._value || (this._value = e.inserted = this.char),
                  e
                );
              },
            },
            ...
            },
            {
              ...
              value: function (e, t, n) {
                ...
                return (
                  null != n && (e.tailShift += this.appendTail(n).tailShift),
                  e
                );
              },
            },
  ...
  !function () {
    ...
    ((e.prototype.add_node = function (e) {
      ...
      (u.prototype.search_string_match = function (e, t) {
        t = t.exec(e);
        return (
          !this.search_contains && null != t && t[1] && (t.index += 1),
          t
        );
      }),
              ...
              e =
                null === e.progress
                  ...
                  : t.query("GET_LABEL_FILE_PROCESSING") +
                    ...
                    "%";
            (r(t.ref.main, e),
              r(t.ref.sub, t.query("GET_LABEL_TAP_TO_CANCEL")));
          },
        ...
        ? ((e = o.element),
          (n = function (e) {
            ...
            return (
              ...
              e.every(function (e) {
                return (
                  T("ALLOW_HOPPER_ITEM", e, { query: o.query }).every(
                    function (e) {
                      return !0 === e;
                    },
                  ) && t(e)
      ...
      (n = n && !i) && !t.ref.browser
        ? (t.ref.browser = t.appendChildView(
            t.createChildView(
              ...
              Object.assign({}, e, {
                onload: function (e) {
                  b("ADD_ITEMS", e, { dispatch: t.dispatch }).then(
                    function (e) {
                      if (on(t, e)) return !1;
...
const formatFileData = (t) => {
  Object.keys(t).forEach((e) => {
    "string" == typeof e &&
      e.startsWith("site-file-upload__") &&
      "string" == typeof t[e] &&
      ((t[e] = t[e].replace(/"/g, "")),
      delete Object.assign(t, { [e.replace("site-file-upload__", "")]: t[e] })[
        e
      ]);
  });
};
...
(deleteParamsFromUrl(["access_token", "nocache"]),
  window.addEventListener("DOMContentLoaded", function () {
    "use strict";
    ((window.siteRuntime = {}), (window.upUtils = {}));
...
>
  ...
  <template x-for="filterV2Item in filtersV2Items">
    ...
    (submitNoIntegrationForm.init(),
      (window.siteRuntime.subscribeMailchimpForm = {
        init: function () {
          for (
      ...
      window.siteRuntime.subscribeMailchimpForm.init(),
      (window.siteRuntime.subscribeZapierForm = {
        init: function () {
          for (
      ...
      window.siteRuntime.subscribeZapierForm.init(),
      (window.siteRuntime.subscribeGoogleSheetForm = {
        init: function () {
          for (
      ...
      window.siteRuntime.subscribeGoogleSheetForm.init(),
      (window.siteRuntime.subscribeWebhookForm = {
        init: function () {
          for (
      ...
      window.siteRuntime.subscribeWebhookForm.init(),
      (window.siteRuntime.subscribeSendToEmailForm = {
        init: function () {
          for (
      ...
      window.siteRuntime.subscribeSendToEmailForm.init(),
      (window.siteRuntime.subscribeSendToMailerliteForm = {
        init: function () {
          for (
      ...
      window.siteRuntime.subscribeSendToMailerliteForm.init(),
      (window.siteRuntime.subscribeCmsForm = {
        init: function () {
          for (
      ...
      window.siteRuntime.subscribeCmsForm.init(),
      (window.siteRuntime.roadmapScroll = {
        init: function () {
          var e,
            t,
      ...
      window.siteRuntime.roadmapScroll.init(),
      (window.siteRuntime.slider = {
        init: function () {
          for (
      ...
      window.siteRuntime.slider.init(),
      (window.siteRuntime.tabs = (function () {
        var t, c;
        function d(e) {
    ...
    (customPopup().bindOpen(),
      ...
      (window.siteRuntime.openPopup = customPopup().openPopup),
      (window.siteRuntime.closeAllPopups = customPopup().closeAllPopups));
    var scrollTo = {
        init: function () {
          $(document).on(
            "click",
      ...
      popup =
        ...
        (window.siteRuntime.stripeCheckout = {
          bind: function () {
                  ...
                  "plan" === (r = s.split("_")[0])
                    ...
                    : "sku" === r
                      ...
                      : "price" === r
                        ? (o[0].price = s)
                        : (alert(
                            "Stripe integration error: wrong product ID was used. Please take a careful look at our guide and copy proper product ID: ",
                          ),
                          console.error(
                            "A message for the website owner: there has been a mistake in setting up your Stripe integration. Please contact the site owner.",
                          )),
                  "price" === r
        ...
        window.siteRuntime.stripeCheckout.bind(),
        (function () {
          var t = {
            openSpeed: 150,
            closeSpeed: 50,
    ...
    const initDirectory = (r) => {
        const a = r.parents(".page-component__bg_image_box").attr("id"),
          l = 0 < r.parents(".uni-is-dark-bg").length;
        var e = formatGoogleSheetUrl(r.data("cmsurl"));
        const u = r.data("directoryitemhtml"),
          c = r.data("sortingfield"),
          d = r.data("searchplaceholder"),
          f = r.data("filterfields"),
          p = r.data("categorycolumn"),
          h = r.data("filteredtagsmode"),
          m = r.data("filterfieldsmode"),
          g = r.data("sortingorder"),
          v = r.data("showmorebuttontext"),
          y = r.data("dynamicurl"),
          _ = r.data("dynamictarget"),
          E = r.data("dynamicurlprefix");
        var t = r.data("buttonversion");
        const b = 2 <= parseInt(t),
          w = "true" === r.data("istagshidden").toString().toLowerCase();
        let T = r.data("topsectionhtml");
        t = JSON5.parse((r.data("filtersv2") || "{}").toString());
        const S = parseInt(r.data("version")),
          I = t.items || [],
          k = r.data("filteredtags");
        let C = parseInt(r.data("maxitems"));
        isNaN(C) && (C = 4);
        var t = r.data("cmstype") || "googleSheets",
          n = r.data("collectionid"),
          i = r.data("customapiurl"),
          o = r.data("apibase") || "";
        r.data("sheetsapibase");
        let s =
          "custom" === t && i
            ? i
            : "googleSheets" === t && e
              ? e
              : "platformCollection" === t && n
                ? o +
                  "/api/v1/websites/list_collection_items?collection_id=" +
                  n
                : "";
        if (!s || (!s.startsWith("https://") && !s.startsWith("http://"))) {
          const A = r.find(".directory-01__items");
          return (A.html(""), void r.removeClass("dir-is-loading"));
        }
        i = getCookie("access_token");
        let x = i ? { headers: { Authorization: "Bearer " + i } } : void 0;
        fetch(s, x)
          .then((e) => {
          ...
          .then((e) => {
            ...
            if (
              ...
              (o = o.filter((e) => filterRowsByFieldsFn(e, f, m))),
              I.forEach((i) => {
                const r = [];
                o.forEach((e, t) => {
                  const n = e[i.column];
              ...
              o.sort((e, t) => {
                if (!c) return 0;
                if ("no_sorting" === c) return 0;
                if ("random_sorting" === c) return Math.random() - 0.5;
                if ("string" != typeof c) return 0;
                let n = c.toLowerCase(),
                  i = !1;
                if (
                  (c.startsWith("-") &&
                    ((n = c.slice(1).toLowerCase()), (i = !0)),
                  "descending" === g && (i = !i),
              ...
              window.uniDirectoryData
                ? (window.uniDirectoryData[a] = o)
                : (window.uniDirectoryData = { [a]: o }),
              (!S || S < 2) &&
                ((T = DEFAULT_DIRECTORY_TOP_SECTION_HTML),
                "no_tags" !== p && 0 === I.length))
            ) {
              let n = [];
              (o.forEach((e) => {
                const t = e[p];
                ...
                I.push({
                  ...
                  multiselect: "off",
                  filters: n,
                  showByFilters: { items: k || "", mode: h || "any" },
                  isHidden: w ? "hidden" : "visible",
                }));
            }
            o = o.filter((e) => filterRowsByFilterV2Fn(e, I));
            const s = r.find(".directory-01__items");
            (s.html(""),
              o.forEach((i, e) => {
                const t = {};
                I.forEach((e) => {
                ...
                let n = "";
                var r = `data-filters='${JSON.stringify(t).replace(/'/g, "&#39;")}'`,
                  e = `<li class="${Object.keys(i).reduce((e, t) => {
                    ...
                    return n && "false" !== n.toString().toLowerCase()
                      ...
                      : e;
                  }, "directory-item-parent")}" ${(n = e >= C ? "style='display:none;'" : n)} ${r}>${replaceWithObjectValues(u, i, y, E, _)}</li>`;
                s.append(e);
              }));
            r.find(".directory-01__search-container").replaceWith(
              ((e) => {
                const t = (d || "")
                  .toString()
                  ...
                  "{{debounce}}":
                    500 < o.length
                      ...
                      : o.length > DEBOUNCE_ROWS_COUNT
                        ...
                        : "1ms",
                  "{{isDarkBg}}": l,
                  "{{filtersV2Items}}": JSON.stringify(I).replace(
                    /'/g,
                    "&#39;",
                  ),
                };
      ...
      initLoadMore =
        ...
        (window.siteRuntime.initDirectory = initDirectory),
...
sizes="${i.sizes}"`));
        ...
        `);
          ...
          (0 < n.length && o.observe(n[0]),
            (window.siteRuntime.loadMorePosts = r),
            (window.siteRuntime.renderBlogPosts = i));
        }),
      inputElements =
    ...
    bindClose: function () {
      $(document).on("click", ".js-close-widget", function (e) {
        ...
        ($("#" + e).toggleClass("state-visible"),
          (localStorage["site-widget-" + e] = "hidden"));
      });
    },
    bindInit: function () {
      var e,
      ...
      0 < t.length &&
        ((e = t.attr("id")),
        "hidden" !== localStorage["site-widget-" + e] &&
          setTimeout(function () {
